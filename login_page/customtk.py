...
def button_function():
    ...
    w = customtkinter.CTk()  
    w.geometry("1280x720")
    w.title('Welcome to the Booland')
    l1=customtkinter.CTkLabel(master=w, text="Boobie boobie boo boo 👻",font=('Century Gothic',60))
    l1.place(relx=0.5, rely=0.5,  anchor=tkinter.CENTER)
    w.mainloop()
    


img1=ImageTk.PhotoImage(Image.open("C:\\Users\\sneha\\Downloads\\Login page\\login_page\\assets\\wp3364662.jpg"))
...
img2=customtkinter.CTkImage(Image.open("C:\\Users\\sneha\\Downloads\\Login page\\login_page\\assets\\Google__G__Logo.svg.webp").resize((20,20), Image.ANTIALIAS))
img3=customtkinter.CTkImage(Image.open("C:\\Users\\sneha\\Downloads\\Login page\\login_page\\assets\\124010.png").resize((20,20), Image.ANTIALIAS))
